...
<body onload="myFunction()">
  ...
  <div class="collapse navbar-collapse justify-content-center align-content-center" id="navbarSupportedContent">
    <ul class="navbar-nav justify-content-center align-content-center">
      <li class="nav-item">
        <a class="nav-link current" href="home.php">Home <span class="sr-only">(current)</span></a>
      </li>
        
        <li class="nav-item">
        <a class="nav-link" href="maddenfranchise.php">Madden Franchise</a>
      </li>
        <li class="nav-item">
          ...
          <div class="hover-3-content px-5 py-4">
            <h3 class="hover-3-title text-uppercase font-weight-bold mb-1"><span class="font-weight-light">FRANCHISE </span></h3>
               ...
               <div class="row">
                ...
                <div class="col-lg-12 pb-4"><h3 align="center">FOLLOW US ON TWITCH</h3><iframe SameSite="None" src="https://player.twitch.tv/?channel=maddenbase&parent=http://maddenbase.com/" frameborder="0" allowfullscreen="true" scrolling="no" height="378" width="100%"></iframe>
</div>
                       <div class="col-lg-12 pb-4"><h3   align="center">TWITCH CHAT LIVE</h3><iframe
  id="chat_embed"
  src="https://www.twitch.tv/embed/maddenbase/chat?parent=http://maddenbase.com/"
  height="378"
 width="100%">
</iframe>
</div>
...
<div class="elfsight-app-03ee2304-19f4-4aa4-aad5-338f6aa195ef"  style="width: 100%; height:378px"></div>
			...
			<div class="row">
                ...
                <div class="col-lg-6 pb-4"><div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/uGSZUuBSDL4" allowfullscreen></iframe>
</div>
</div>
                       <div class="col-lg-6 pb-4">
						   <div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/W5d-yHKzzWE" allowfullscreen></iframe>
</div>
</div>
				             <div class="col-lg-6 pb-4">
						   <div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/pKmoAxfF9nA" allowfullscreen></iframe>
</div>
</div>
				                   <div class="col-lg-6 pb-4">
						   <div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/xE6-6xeA1cg" allowfullscreen></iframe>
</div>
</div>
				                   <div class="col-lg-6 pb-4">
						   <div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/bHxw_k56Yoo" allowfullscreen></iframe>
</div>
</div>
				                   <div class="col-lg-6 pb-4">
						   <div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/1OiNEtnsU-o" allowfullscreen></iframe>
</div>
</div>                 <div class="col-lg-6 pb-4">
						   <div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/pKmoAxfF9nA" allowfullscreen></iframe>
</div>
</div>
  ...
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/RI4zuTeSlmQ" allowfullscreen></iframe>
</div>
</div>
