...
<title>Madden tips tricks and eBooks</title>
<!-- InstanceEndEditable -->
  ...
  <div class="collapse navbar-collapse justify-content-center align-content-center" id="navbarSupportedContent">
    <ul class="navbar-nav justify-content-center align-content-center">
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link current" href="maddentipstricksebooks.php">Tips Tricks & eBooks <span class="sr-only">(current)</span></a>
      </li>
        <li class="nav-item">
